...
app.layout = html.Div(children=[
    dbc.Row([
        ...
        dbc.Col([
            ...
            dbc.Row([dcc.Graph(id='income_per_product_fig')])], sm=10)])])
# ===== Callbacks ========
